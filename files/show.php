...
<aside id="sidebar">
  <div id="item">
      ...
      <div id="link_to_item" class="element">
          <div class="element-text"><?php $item = $file->getItem(); echo link_to_item(metadata($item, array('Dublin Core', 'Title')), array(), 'show', $item); ?></div>
      </div>
